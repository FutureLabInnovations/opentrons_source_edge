...
def run(protocol: protocol_api.ProtocolContext):
    ...
    def run_one_plate(plate, colour_name, single_tip_index, multi_tip_col_index):
        ...
        for i in range(8, 96):  # wells 8..95 in column-major order = cols 2..12
            ...
            flex_s.aspirate(DILUENT_UL, src_well.bottom(src_z))
            flex_s.dispense(DILUENT_UL, dst_well.top(z=-5))
        ...
        for i in range(8):
            ...
            flex_s.aspirate(STOCK_UL, colour_tracker.well.bottom(src_z))
            flex_s.dispense(STOCK_UL, dst_well.top(z=-5))
        ...
        for _ in range(11):
            ...
            flex_m.aspirate(XFER_UL, src_well.bottom(z=2))
            flex_m.dispense(XFER_UL, dst_well.top(z=-5))
